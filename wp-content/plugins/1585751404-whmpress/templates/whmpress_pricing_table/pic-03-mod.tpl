...
<style>
	...
	.whmpress.whmpress_pricing_table.pic-03 .pricing_table_heading .holder{
		width: 60%;
		padding-bottom: 60%;
		background: #f5f5f5 url(http://sajid.hostriplex.com/whmpress/wp-content/uploads/2018/01/download.png) no-repeat right bottom;
		background-size: 76%;
		border-radius: 50%;
		cursor: pointer;
		position: relative;
	...
	.whmpress.whmpress_pricing_table.pic-03 .pricing_table_heading .holder:hover{
		background: #e8e8e8 url(http://sajid.hostriplex.com/whmpress/wp-content/uploads/2018/01/download.png) no-repeat right bottom;
		background-size: 80%;
	}
