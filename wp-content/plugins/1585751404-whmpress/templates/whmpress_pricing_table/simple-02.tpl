...
<style>
	...
	.whmpress.whmpress_pricing_table.simple-02 .pricing_table_detail.details .holder p{
		margin-bottom: 0;
	}
...
<div class="whmpress whmpress_pricing_table simple-02 {$featured}" id="{$random_id}">
	<div class="pricing_table_heading">
		<div class="holder">
			<strong><i class="fa {$sub_icon}"></i> {$product_name}</strong>
		</div>
	</div>
